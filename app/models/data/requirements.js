...
requirements = [
    ...
    },
    {
        ...
        name: 'Fit to customer infrastructure',
        description: '',
        topic: 'Technology',
        popularity: 70
    },
    {
        _id: '55974b303dc107cb7545381a',
        name: 'Can be distributed',
        description: '',
        topic: 'Technology',
        popularity: 60},
    {
        _id: '55974b313dc107cb7545381b',
        name: 'Quick and easy deployment',
        description: '',
        topic: 'Technology',
        popularity: 85
    },
    {
        _id: '55974b323dc107cb7545381c',
        name: 'Cost of ownership as low as possible',
        description: '',
        topic: 'Technology',
        popularity: 95
    },
    {
        ...
        name: 'Minimal impact on servers and end points',
        description: '',
        topic: 'Technology',
        popularity: 90
    },
    {
        _id: '55974b333dc107cb7545381e',
        name: 'Can work in parallel to other tools',
        description: '',
        topic: 'Technology',
        popularity: 90
    },
    {
        _id: '55974b333dc107cb7545381f',
        name: 'Minimal false positives',
        description: '',
        topic: 'Technology',
        popularity: 45
    },
    {
        _id: '55974b343dc107cb75453820',
        name: 'Integration with management control and monitoring systems',
        description: '',
        topic: 'Technology',
        popularity: 70
    },
...

    {
        ...
        name: 'Vendor',
        description: 'How risky is this vendor?',
    ...
    },
    {
        ...
        name: 'Vendor Locking',
        description: 'Does choosing this solution lock us on this vendor?',
        topic: 'Risk management',
        popularity: 75
    },
    {
...

    {
        ...
        name: 'Security',
        description: 'Level of security of data storage, passwords, etc. Usage of SingleSignOn, Two factor authentication, etc.',
        topic: 'System Interfaces and user management',
        popularity: 45
    },
    {
        _id: '55974b3a3dc107cb7545382a',
        name: 'Hardenning according to procedure',
        description: '',
        topic: 'System Interfaces and user management',
        popularity: 45
    },
    ...
    },
    {
        ...
        name: 'Logging of management system user access',
        description: '',
        topic: 'System Interfaces and user management',
        popularity: 70
    },

    {
        ...
        name: 'Answers to business requirement',
    ...
    },
    {
        ...
        name: 'Integration with 24x7 SOC',
        description: 'Integration with 24x7 SOC',
        topic: 'Threat Prevention Functionality',
        popularity: 90,
        category: 'Threat Prevention'
    },
